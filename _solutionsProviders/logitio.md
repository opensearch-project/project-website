...
products:
  ...
  - url: 'https://logit.io/platform/observability/siem-as-a-service/'
    ...
    description: 'Logit.io&apos;s SIEM as a Service platform allows security practitioners to consolidate pre-existing log and metrics data into an intutitive dashboard to provide organisations with the security and analysis their business’s needs to ensure compliance, alert on threats and identify problematic event logs quickly.'
