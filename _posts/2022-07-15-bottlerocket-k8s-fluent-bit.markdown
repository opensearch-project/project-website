---
layout: post
title:  "How to use Fluent Bit and OpenSearch with Bottlerocket and Kubelet logs"
authors:
  - kyledvs
date:   2022-07-15
categories:
...
![Block diagram of Bottlrocket](/assets/media/blog-images/2022-07-15-bottlerocket-k8s-fluent-bit/container-oriented.png){: .img-fluid}
...
On the left side of the screen you can type your adhoc queries. First, run the following query to confirm that you’ve go a Fluent Bit sourced index:
...
With this basic information you can build dashboards and visualizations, [run queries](https://opensearch.org/docs/2.1/search-plugins/sql/index/), [setup alerts](https://opensearch.org/docs/2.1/monitoring-plugins/alerting/index/), and even [use anomaly detection](https://opensearch.org/docs/2.1/monitoring-plugins/ad/index/) to automatically find unusual blips in your kubelet logs. 

Bottlerocket, Kubernetes, OpenSearch, and Fluent Bit are a powerful combination. Getting them all configured requires a few special tweaks, but nothing you can’t handle with the right information. If you want to find out more, make sure and checkout the [Bottlerocket GitHub repo](https://github.com/bottlerocket-os/bottlerocket) or ask a question on the [Bottlerocket Discussion Forum](https://github.com/bottlerocket-os/bottlerocket/discussions).
