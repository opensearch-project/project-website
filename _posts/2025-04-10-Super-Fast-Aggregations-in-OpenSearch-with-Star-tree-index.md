...
categories:
  - technical-posts
meta_keywords:  star-tree index, OpenSearch aggregations, multi-field index, query performance, star-tree mapping, search optimization, query latency, performance tuning.
meta_description: Learn how the star-tree index feature in OpenSearch accelerates data aggregations through precomputed metrics, delivering faster query performance and improved scalability for your real-time analytics workloads.
---
...
|-------|----------------------|---------|
| Metric aggregation for status = `200` | 200,000,000 | 4,200  |
