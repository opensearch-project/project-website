...
In our last [blog](https://opensearch.org/blog/improving-document-retrieval-with-sparse-semantic-encoders/) we introduced Neural Sparse feature, a new efficient method of semantic retrieval GA in [2.11](https://opensearch.org/versions/opensearch-2-11-0.html) release. We released two sparse encoding models on OpenSearch [modelhub](https://opensearch.org/docs/latest/ml-commons-plugin/pretrained-models/#sparse-encoding-models) and Hugging Face [modelhub](https://huggingface.co/opensearch-project). Both models have leading search relevance among sparse encoding models with same architecture. With Lucene inverted index, users can perform high-quality semantic search with low resource consumption.
