...
categories: 
  - community
twittercard:
  description: "In the first installment of our From the editor’s desk series, we focused on the OpenSearch Project and inclusion, a subject that is foundational to who we are and how we talk to each other as a community. For the second installment, we’d like to focus on another subject related to community interaction: voice and tone."
