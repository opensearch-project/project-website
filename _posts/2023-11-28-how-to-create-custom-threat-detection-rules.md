---
layout: post
title:  "How to create custom Threat Detection Rules in Security Analytics"
authors:
- xeniatup
- jimishs
- sandeshkr419
...
To get started on creating a custom detection rule for a custom log source or application log, go to [documentation](https://opensearch.org/docs/latest/security-analytics/usage/rules/#creating-detection-rules). To learn more about security analytics and its capabilities, go to [documentation](https://opensearch.org/docs/latest/security-analytics/index/).
