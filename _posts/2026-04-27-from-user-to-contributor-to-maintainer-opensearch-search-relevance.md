...
meta_description: A Staff Software Engineer reflects on going from OpenSearch user to search relevance maintainer first PRs, community triage, reviews, RFCs, and lessons for aspiring contributors.
...
Two years ago, I was an OpenSearch user at Cloudera, running queries, tuning configurations, and occasionally frustrated by search results that didn't quite make sense. Today, I'm a maintainer of the search relevance plugin ([dashboards-search-relevance](https://github.com/opensearch-project/dashboards-search-relevance) and [search-relevance](https://github.com/opensearch-project/search-relevance)) in OpenSearch. This is the story of how that happened, and what I learned along the way.
...
On the frontend side, my first contribution was [supporting GUID filtering in Query Sets](https://github.com/opensearch-project/dashboards-search-relevance/pull/687), a small feature that lets users filter by unique identifiers. Again, not a massive change, but it taught me the patterns of the Dashboards plugin, the review process, and the rhythm of contributing.
...
### On the backend ([search-relevance](https://github.com/opensearch-project/search-relevance))

- Fixed a [floating-point precision bug](https://github.com/opensearch-project/search-relevance/pull/308) in the weight generation logic used by hybrid search (combining lexical and vector search results), which was producing incorrect search quality metrics.
- Added [status filtering to the List Judgments API](https://github.com/opensearch-project/search-relevance/pull/304) to address incomplete judgment ratings groups being shown during selection. This one required understanding the full lifecycle of judgment objects.
- Introduced [judgment thresholds for metrics calculation](https://github.com/opensearch-project/search-relevance/pull/394), giving users more control over how search quality is measured.
- [Extended the set of search quality metrics](https://github.com/opensearch-project/search-relevance/pull/397) available for evaluation.
- Built the feature to [provide a name and description for experiments](https://github.com/opensearch-project/search-relevance/pull/408), a change that touched the core experiment workflow.

### On the frontend ([dashboards-search-relevance](https://github.com/opensearch-project/dashboards-search-relevance))

- Implemented the [resizable query section](https://github.com/opensearch-project/dashboards-search-relevance/pull/791), a significant UX overhaul that made the comparison interface much more usable.
- Built [support for manually creating a Query Set](https://github.com/opensearch-project/dashboards-search-relevance/pull/754) from the UI, something users had been asking for.
- Created the feature to [reuse Search Configurations with the Single Query Comparison UI](https://github.com/opensearch-project/dashboards-search-relevance/pull/727), connecting previously siloed parts of the workflow.
- [Improved the Judgment Detail page UX](https://github.com/opensearch-project/dashboards-search-relevance/pull/713), making it easier for users to work with judgment data.
- Fixed a [persistent bug with deleting judgment ratings](https://github.com/opensearch-project/dashboards-search-relevance/pull/751) that had been affecting users, rethinking parts of the state management.
...
**Writing RFCs.** I authored an [RFC for the search-relevance project](https://github.com/opensearch-project/search-relevance/issues/402), proposing design changes and inviting community feedback before writing a single line of implementation code.
...
I recently became a maintainer of the search relevance plugin ([dashboards-search-relevance](https://github.com/opensearch-project/dashboards-search-relevance) and [search-relevance](https://github.com/opensearch-project/search-relevance)) in OpenSearch. But the title changes less than you'd think. I'm still doing the same work: reviewing PRs, filing issues, joining triage calls, and writing code to make search relevance tooling better for everyone who uses OpenSearch.
...
Come say hi on the [OpenSearch Slack](https://opensearch.org/slack.html), join a [triage meeting](https://www.meetup.com/opensearch/events/), or pick up a [good first issue](https://github.com/opensearch-project/dashboards-search-relevance/contribute). I'll see you there.
