...
Figure 1: Local inference on data nodes
...
Figure 2: Local inference on ML nodes
...
Figure 3: Remote inference on data nodes
...
Figure 4: Remote inference on ML nodes
...
* Configuring an OpenSearch Cluster for Massive Scale Semantic Search
