...
We are thrilled with the progress we have made with extensibility so far and the early performance benchmarking results. Before we commit to releasing this experimental feature and the SDK as generally available, we would like your feedback. After reading the [extension documentation](https://opensearch-project.github.io/opensearch-sdk-java/), try implementing an experimental extension and give us feedback by posting on the [OpenSearch forum](https://forum.opensearch.org/) or creating an issue in the [`opensearch-sdk-java` repo](https://github.com/opensearch-project/opensearch-sdk-java/). We can’t wait to hear from you!
