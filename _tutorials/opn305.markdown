...
![GitPod Loading](/assets/media/tutorials/opn305/gitpod-layout.png){: .img-fluid}
...
➡️ <a href="http://localhost:5601/" class="gitpod-replace-port" port="5601">Launch OpenSearch Dashboards</a>.
{: .gitpod-visible.gitpod-dashboards-ready-visible }
