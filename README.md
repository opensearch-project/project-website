...
1. A technical writer performs an editorial review.
...
For information about writing and structuring blog posts, including editorial guidance, see the [Blog Style Guide](https://style-guide.opensearch.org/BLOG_STYLE_GUIDE.html). For general style, writing, and formatting standards, see the [OpenSearch Content Style Guide](https://style-guide.opensearch.org/).
